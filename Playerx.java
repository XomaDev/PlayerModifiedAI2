...
package com.kumaraswamy.playerx;
...
public final class Playerx extends AndroidNonvisibleComponent implements OnCompletionListener, OnPauseListener, OnResumeListener, OnDestroyListener, OnStopListener, Deleteable {
     ...
     * @param container
     */
    public Playerx(ComponentContainer container) {
        ...
        if (MediaUtil.isExternalFile(form, tempPath)
            ...
            form.askPermission(READ_EXTERNAL_STORAGE, new PermissionResultHandler() {
                ...
                public void HandlePermissionResponse(String permission, boolean granted) {
                    if (granted) {
                        Playerx.this.Source(tempPath);
                    } else {
                        form.dispatchPermissionDeniedEvent(Playerx.this, "Source", permission);
                    }
                }
            });
            return;
